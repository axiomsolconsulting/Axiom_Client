...
export default function AxiomCTASection() {
    ...
    return (
        <section className="bg-CTA py-16 md:py-32 px-4 sm:px-6 lg:px-8">
            <div className="container px-4 mx-auto  ">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
                    {/* Left Div */}
                    <div>
                        <h2 className=" text-4xl md:text-[44px] md:leading-[60px] font-semibold text-gray-900 mb-10  md:pr-5">Discover Axiom: Your Gateway To Custom Software Solutions. Contact Us Today.</h2>
