    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden ">
            ...
            <div className="relative z-10 text-center px-4">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mb-10  mx-auto">Axiom is your strategic partner, delivering tailored tech solutions to boost efficiency, foster innovation, and drive long-term success.</p>
                <Link href="/contact" className="bg-blue-500  text-white font-semibold py-4 px-8 rounded-md hover:bg-white hover:text-black transition-colors duration-300">
                    Book a Call
                </Link>
            </div>
