    ...
    <>
      <div>
        <h2 className="text-[44px] leading-[60px] font-semibold">
          We will be happy to tell you more about what{" "}
          <span className="text-[var(--Blue-Color)] italic">WE CAN DO</span> for
          you
        </h2>
        <p className="text-[#7B8CA3] text-lg max-w-xl mt-5">
          We&apos;d love to connect with you and learn more about what we can
          build together. Tell us a few details and we&apos;ll be in touch.
        </p>
      </div>
      {/* Contact Forn */}
      <form
        onSubmit={handleSubmit}
        className="space-y-6  bg-[#011330] border-b-0 pb-10 rounded-t-[20px] px-10 pt-10"
      >
        <div className="grid md:grid-cols-2 gap-6">
          <div className="relative w-full">
            <input
              ...
              name="quoteName"
              type="text"
              className="w-full px-3 py-2 bg-[#011330] border-b border-[#305075] focus:outline-none "
            ...
            <label
              htmlFor="quoteName"
              className={`absolute left-3 top-2 text-sm text-gray-400 transition-all duration-200 transform ${
                formData.quoteName
                  ? "-translate-y-6 scale-90 text-blue-500"
                  : ""
            ...
            {errors.quoteName && (
              <p className="text-red-500 text-sm mt-1">{errors.quoteName}</p>
            )}
          </div>
          ...
          <div className="relative w-full mb-4">
            <input
              ...
              name="quoteEmail"
              type="email"
              className="w-full px-3 py-2 bg-[#011330] border-b border-[#305075] focus:outline-none peer"
            ...
            {errors.quoteEmail && (
              <p className="text-red-500 text-sm mt-1">{errors.quoteEmail}</p>
            )}
          </div>
          ...
          <div className="relative w-full mb-4">
            ...
            {errors.quoteMobile && (
              <p className="text-red-500 text-sm mt-1">{errors.quoteMobile}</p>
            )}
          </div>
          ...
          <div className="relative w-full mb-4">
            <select
              ...
              className="w-full px-3 py-2 bg-[#011330] border-b border-[#305075] appearance-none focus:outline-none  peer"
            ...
            <label
              htmlFor="quoteTechnology"
              className={`absolute left-3 top-2 text-sm text-gray-400 transition-all duration-200 transform ${
                formData.quoteTechnology
                  ? "-translate-y-6 scale-90 text-blue-500"
                  : ""
              } peer-focus:-translate-y-6 peer-focus:scale-90 peer-focus:text-blue-500`}
            >
            ...
            {errors.quoteTechnology && (
                <p className="text-red-500 text-sm mt-1">{errors.quoteTechnology}</p>
            )}
        ...
        <div className="relative w-full mb-4">
          <textarea
            ...
            className="w-full px-3 py-2 bg-[#011330] border-b border-[#305075] min-h-[120px] focus:outline-none peer"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="bg-[var(--Blue-Color)] text-lg text-white font-medium py-3 px-6 rounded-md hover:bg-white hover:text-black transition-colors duration-300"
          >
