        ...
        <>
            ...
            <div className="relative ">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-white px-3">
                    ...
                    <p className="text-center text-3xl md:text-6xl md:leading-[80px] font-medium max-w-[824px] mt-5">Updates, Insights and Tips</p>
                    <p className="text-center text-lg md:text-xl md:leading-[32px] max-w-2xl mt-7">Stay ahead with Axiom as we bring you the latest updates, insightful perspectives, and practical tips.</p>
                    <div className="border-2 border-[var(--Blue-Color)] w-12 my-7"></div>
